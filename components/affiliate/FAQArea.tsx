 ...
 const accordion_data: accordion_data_type[] = [
        ...
        },
        {
            ...
            answer: <ul>
                ...
                <li>- Applications de l’intelligence artificielle dans les secteurs industriels</li>
        ...
        },
        {
            ...
            <li>- Applications et cas d’utilisation des systèmes IoT intelligents</li>
            </ul>
       </ul>,    
            accordion_id: "Three",
            collapsed: "collapsed", 
        ...
        },
        {
            ...
            answer: <ul>
                ...
                <li>- Reconnaissance faciale et biométrie</li><li>Analyse mathématique</li>
        ...
        },  
        {
            ...
            <li>- Sécurité et confidentialité des données dans l’ingénierie des données</li>
       </ul>,    
            accordion_id: "five",
            collapsed: "collapsed", 
            aria_expanded: false, 
        ...
        },  
        {
            ...
            <li>Contrôle adaptatif et apprentissage automatique dans les systèmes dynamiques</li>
            <li>Intégration de l’IA dans les systèmes de contrôle de véhicules autonomes</li>
            <li>Défis et perspectives de l’IA dans les systèmes de contrôle en temps réel</li>
       </ul>,    
            accordion_id: "six",
            collapsed: "collapsed", 
            aria_expanded: false, 
        ...
        },
        {
            ...
            <li>- Intelligence artificielle pour la détection des menaces et l’analyse de sécurité</li>
            <li>- Conformité réglementaire et gouvernance en matière de cybersécurité</li>
       </ul>,    
            accordion_id: "seven",
            collapsed: "collapsed", 
            aria_expanded: false, 
        ...
        },
        {
            ...
            answer: <ul>
                <li>- Modèles mathématiques et informatiques pour prédire la propagation des maladies</li>
                <li>- Analyse des données épidémiologiques pour la prévision des maladies</li>
                <li>- Études longitudinales et conceptions de cohortes pour comprendre l'étiologie des maladies</li>
                <li>- Mise en œuvre de programmes de vaccination et de stratégies de prévention des maladies</li>
                </ul>,    
            accordion_id: "huit",
            collapsed: "collapsed", 
            aria_expanded: false, 
                                    ...
                                    {accordion_data.map((item) => (
                                        <div key={item.id} className="accordion-items">
                                            ...
                                            <div
                                                ...
                                                <div className="accordion-content faq_content" style={{color : "#052c65"}}>
                                                    {item.answer}
                                                </div>
                                            </div>
                                         </div>
