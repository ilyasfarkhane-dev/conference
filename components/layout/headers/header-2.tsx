      ...
      <header className="header-transparent header-2 header-space">
        ...
        <div
          className={`header-area ${
            style ? "header-transparent header-space" : "header-bottom-space"
          } pt-45 pb-45`}
        >
          <div className="container-fluids">
            <div className="row">
              ...
              <div className="col-xl-6 col-lg-6 d-none d-lg-block">
                <div
                  className={`main-menu ${
                    style ? "contract-menu" : "text-center"
                  }`}
                >
                  <nav id="mobile-menu">
                    <NavMenu />
                ...
                <div className="header-btn f-right d-none d-md-block">
                  <Link href={"/registration"}>
                    <button className="btn">
                      <i className="far fa-user"></i> Registration
                    </button>
                  </Link>
                </div>
              </div>
